...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		blogchainmodule.AppModuleBasic{},
...
func New(
	...
	*/
	...
	app.BlogchainKeeper = *blogchainmodulekeeper.NewKeeper(
		appCodec,
		keys[blogchainmoduletypes.StoreKey],
		keys[blogchainmoduletypes.MemStoreKey],
		app.GetSubspace(blogchainmoduletypes.ModuleName),
	)
	blogchainModule := blogchainmodule.NewAppModule(appCodec, app.BlogchainKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(blogchainmoduletypes.ModuleName)
